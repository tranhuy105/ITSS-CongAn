...
import { getDishesAdmin, deleteDish } from '@/services/dishService';
...
export const AdminDishList = () => {
  ...
  const handleDelete = (id: string, name: string) => {
    if (window.confirm(t('adminPages.dishes.confirm.delete', { name }))) {
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="w-[20%]">{t('adminPages.dishes.table.category')}</TableHead>
                  <TableHead className="w-[15%]">{t('adminPages.dishes.table.region')}</TableHead>
                  <TableHead className="w-[15%]">{t('adminPages.dishes.table.rating')}</TableHead>
                    ...
                    <TableRow key={dish._id}>
                      ...
                      <TableCell className="text-right flex justify-end gap-2">
                        ...
                        <Button
                          ...
                          size="icon-sm"
                          disabled={isMutating}
                          onClick={() => handleDelete(dish._id, dish.name[language])}
                        >
