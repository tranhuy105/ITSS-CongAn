                ...
                <div className="container mx-auto py-6 px-4 sm:px-6 lg:px-8 max-w-6xl">
                    <Card className="border-destructive/50 bg-destructive/5">
                        <CardContent className="p-4">
                            <p className="text-sm text-destructive">Failed to load dish details. Please try again.</p>
                        </CardContent>
                    </Card>
                </div>
            </AppLayout>
            ...
            <div className="container mx-auto py-6 px-4 sm:px-6 lg:px-8 max-w-6xl">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 mb-8">
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        ...
                        <Button size="sm" className="w-full" onClick={() => navigate(`/restaurants?dish=${id}`)}>
                                ...
                                {dish.ingredients.map((ingredient: any, index: number) => (
                                    <div key={index} className="flex items-start gap-2 text-sm">
                                        ...
                                        <div>
                                            ...
                                            {ingredient.quantity && (
                                                <span className="text-muted-foreground ml-1.5">— {ingredient.quantity}</span>
                                            )}
                                        </div>
                                    </div>
                                ))}
                ...
                <Card>
                    <CardContent className="p-8 text-center">
                        ...
                        <p className="text-sm text-muted-foreground">Reviews will be available soon</p>
                    </CardContent>
                </Card>
            </div>
        </AppLayout>
